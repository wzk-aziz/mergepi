 ...
 */
final class Version20240307142648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE echange ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE echange ADD CONSTRAINT FK_B577E3BFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_B577E3BFA76ED395 ON echange (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B577E3BFA76ED395 ON echange');
        $this->addSql('ALTER TABLE echange DROP user_id');
